...
<div class="container-fluid">
  <div class="row">
    <div class="col-md-4 col-sm-5">
      ...
      <div class="carousel slide " id="movies_slide" data-ride="carousel">
         <!-- indicators dot nov -->
         <ol class="carousel-indicators">
           <li data-target="#movies_slide" data-slide-to="0" class="active"></li>
           <li data-target="#movies_slide" data-slide-to="1"></li>
         </ol>
         <!-- wrapper for slides -->
        ...
        <a  class="left carousel-control "href="#movies_slide" role="button" data-slide="prev">
         <span class="glyphicon glyphicon-chevron-left" aria-hiden="true"></span>
         <span class="sr-only">Previous</span>
        </a>
        <a  class="right carousel-control "href="#movies_slide" role="button" data-slide="next">
    ...
    <div class="carousel slide" data-ride="carousel" id="movies_card_slide">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 lead">
                    <a class="btn btn-outline-secondary" href="#movies_card_slide" data-slide="prev" title="go back"><i class="fa fa-lg fa-chevron-left"></i></a>
                    <a class="btn btn-outline-secondary" href="#movies_card_slide" data-slide="next" title="more"><i class="fa fa-lg fa-chevron-right"></i></a>
                </div>
            </div>
        </div>
