...
<div class="container-fluid">
  <div class="row">
    <div class="col-md-4 col-sm-5">
      <!-- <img src="images/music.jpeg" style="width:400px;" alt=""> -->
      <div class="carousel slide " id="adventure_slide" data-ride="carousel">
         <!-- indicators dot nov -->
         <ol class="carousel-indicators">
           <li data-target="#adventure_slide" data-slide-to="0" class="active"></li>
           <li data-target="#adventure_slide" data-slide-to="1"></li>
         </ol>
         <!-- wrapper for slides -->
        ...
        <a  class="left carousel-control "href="#adventure_slide" role="button" data-slide="prev">
         <span class="glyphicon glyphicon-chevron-left" aria-hiden="true"></span>
         <span class="sr-only">Previous</span>
        </a>
        <a  class="right carousel-control "href="#adventure_slide" role="button" data-slide="next">
    ...
    <div class="col-md-8 col-sm-7"style="margin:0px">
    <!--concerts card slider -->
    <div class="carousel slide" data-ride="carousel" id="adventure_card_slide">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 lead">
                    <a class="btn btn-outline-secondary" href="#adventure_card_slide"  data-slide="prev" title="go back"><i class="fa fa-lg fa-chevron-left"></i></a>
                    <a class="btn btn-outline-secondary" href="#adventure_card_slide"  data-slide="next" title="more"><i class="fa fa-lg fa-chevron-right"></i></a>
                </div>
            </div>
        </div>
        <div class="container  carousel-inner">
            <div class="row row-equal carousel-item active ">
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-img-top ">
                            <img class="img-fluid card-img-top-250" src="http://i.imgur.com/EW5FgJM.png" alt="Carousel 1">
                        </div>
                        <div class="card-block ">
                            <h6 class="small text-wide">Insight</h6>
                            <h4>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-img-top ">
                            <img class="img-fluid card-img-top-250" src="http://i.imgur.com/Hw7sWGU.png" alt="Carousel 2">
                        </div>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-img-top ">
                            <img class="img-fluid card-img-top-250" src="http://i.imgur.com/g27lAMl.png" alt="Carousel 3">
                        </div>
                        <div class="card-block p-t-2">
...
<!-- categories slide js -->
    ...
    (function($) {
      ...
      $('.next').click(function(){$('#adventure_card_slide').carousel('next');return false; });
      $('.prev').click(function(){ $('#adventure_card_slide').carousel('prev');return false; });
