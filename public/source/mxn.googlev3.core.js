...
Mapstraction: {
	...
	mousePosition: function(element,lat,lon,place) {

		var map = this.maps[this.api];
		var locDisp = document.getElementById(element);
		var locPlace = document.getElementById(place);
		...
		if (locDisp !== null) {
			google.maps.event.addListener(map, 'mousemove', function (point) {
				...
				latitude.innerHTML = point.latLng.lat();
				longitude.innerHTML =	point.latLng.lng();

				// find place using lat and lon
				// <!-- find gelocation -->
					function displayLocation(latitude,longitude){
						...
						request.onreadystatechange = function(){
						   ...
						   locPlace.innerHTML  = "<i class='fa fa-hand-pointer-o'></i>&nbsp;" + address.formatted_address;
							}
						};
						request.send();
					};
					...
					var successCallback = function(position){
						var x = point.latLng.lat();
						var y =  point.latLng.lng();
						displayLocation(x,y);
					};
					...
					var errorCallback = function(error){
						...
						switch(error.code) {
							case 1:
								errorMessage = '(PLEASE TURN ON LOCATION TO USE THIS FEATURE)'; //'Permission denied '+
								break;
							case 2:
								errorMessage = '(PLEASE CHECK YOUR INTERNET CONNECTION)'; //'Position unavailable '+
								break;
							case 3:
								errorMessage = "please wait..."; //'Timeout: '+
								break;
						}
					 locPlace.innerHTML  = "Your hover location is being loaded :"+errorMessage;
					};
				...
				// find place using lat and lon end
